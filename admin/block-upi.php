...
if(isset($_POST['save_upi'])) {
    ...
    // Admin table update
    $query = "UPDATE admin SET blocked_upi = '$upi_id' WHERE sn = '1'";
...
$res = mysqli_query($con, "SELECT blocked_upi FROM admin WHERE sn = '1'");
...
<div class="main-content" style="background-color: #e9e9e9; min-height: 100vh;">
    <div class="container-fluid pt-3">
        ...
        <p style="font-family: serif; color: #444; margin-bottom: 10px; font-size: 18px;">Add Block Upi</p>
            ...
            <div class="row">
                <div class="col-12">
                    <input type="text" 
                           name="upi_id" 
                           class="form-control" 
                           value="<?php echo $row['blocked_upi']; ?>"
